...
//        System.out.println("total rule count: " + ruleCount);
    ...
    private void scanIntoTable(SequenceDatabaseWithUtilityALLRU database){
                ...
                for (int nextIndex : nextPlaces.getValue()){
                    ...
                    for(int nowIndex : nowItem.getOccurArrayByLine(line)){
                        ...
                        if(linkTable.getLineIndexByNameLineArrayIndex(entry.getKey(),line,nextIndex)
                            ...
                            double nowRU = linkTable.getRemainUtility(entry.getKey(),line,nextIndex)+nowItem.getUntilUtilityByArrayIndex(line,nowPosition);
                            ...
                            // this means more than one times occur
                                ...
                                if (nowRU>maxRU){
                                    untilMaxRemainUtility += (nowRU-maxRU);
                                    maxRU = nowRU;
                                }
...
//                System.out.println(entry.getKey() + " : " + entry.getValue());
    ...
    public void printStats() throws IOException{
        ...
        System.out.println("=============================================================================");
        System.out.println("--- ALLRU HUSRM algorithm for high utility sequential rule mining ---");
        System.out.println("=============================================================================");
